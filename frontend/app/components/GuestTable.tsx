...
export default function GuestTable({
  ...
  async function resetViews(id: string) {
    ...
    try {
      ...
      await fetch(`http://localhost:3001/api/guest/reset/${id}`, {
        method: "POST"
      })
  ...
  async function toggleGuest(id: string, active: boolean) {
    ...
    try {
      ...
      await fetch(`http://localhost:3001/api/guest/toggle/${id}`, {
        method: "POST",
        headers: {
            ...
            return (
              ...
              >
                ...
                <td className="p-3 flex flex-wrap gap-2">
                  ...
                  {/* BLOCK */}
                  <button
                    onClick={() => toggleGuest(g.id, g.active)}
